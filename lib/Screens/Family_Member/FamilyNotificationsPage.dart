...
class FamilyNotificationsPage extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: AnimationLimiter(
            child: ListView.builder(
              itemCount: 5, // Adjust the number of notifications dynamically
                ...
                return AnimationConfiguration.staggeredList(
                  ...
                  child: SlideAnimation(
                    ...
                    child: FadeInAnimation(
                      child: _buildFamilyNotificationTile(index, screenSize, context),
                    ),
                  ),
                );
              },
  ...
  Widget _buildFamilyNotificationTile(int index, Size screenSize, BuildContext context) {
    return Container(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  "Details for Family Notification ${index + 1}",
                  style: TextStyle(fontSize: 16, color: Colors.white), // Adjust text color for readability
                ),
                SizedBox(height: 10),
                Text(
                  "Here you can provide more specific information about the notification, tailored to family members. Include any relevant details that would be pertinent to the family's awareness and response.",
